...
<head>
    <meta charset="utf-8" />
    <title><?php echo $title ?> | PPDB Online 2021</title>
    ...
    <link href="<?= base_url() ?>/public/template/viewer/viewer.css" rel="stylesheet">
    <script src="<?= base_url() ?>/public/template/viewer/viewer.js"></script>
